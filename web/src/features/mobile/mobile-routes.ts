export const mobileRoutes = {
  ...
  conversationManage: (conversationId: string) => `/mobile/conversations/${encodeURIComponent(conversationId)}/manage`,
  groupMembers: (conversationId: string) => `/mobile/conversations/${encodeURIComponent(conversationId)}/members`,
  contacts: "/mobile/contacts",
  contactProfile: (accountId: string, wxid: string) => `/mobile/contacts/${encodeURIComponent(accountId)}/${encodeURIComponent(wxid)}`,
  admin: "/mobile/admin",
